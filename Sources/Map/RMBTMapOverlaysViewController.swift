...
private extension UIColor {
    static let mapTypeSelectedBackground = UIColor(red: 1.0, green: 113.0/255.0, blue: 10.0/255.0, alpha: 1.0)
    static let mapTypeUnSelectedBackground = UIColor.clear
    
    static let mapTypeSelectedTitle = UIColor(red: 1.0, green: 113.0/255.0, blue: 10.0/255.0, alpha: 1.0)
