...
public class RMBTConfig {
    ...
    var RMBT_URL_HOST: String { return "https://test.matuok.lt" }
    // Control server base URL used when user has enabled the "IPv4-Only" setting
    // Ditto for the (debug) "IPv6-Only" setting
    var RMBT_IPV6_URL_HOST: String { return "https://test.matuok.lt" }
    ...
    static let RMBT_PROJECT_URL = "https://test.matuok.lt/"
    static let RMBT_PROJECT_EMAIL = "mail@lexita.lt"
    static let RMBT_PRIVACY_TOS_URL = "https://test.matuok.lt/$lang/tc_ios.html"

    // Note: stats url can can be replaced with the /settings response from control server
    static let RMBT_STATS_URL = "https://test.matuok.lt/lt/Statistik"

    static let RMBT_REPO_URL = "https://github.com/rtr-nettest/open-rmbt-ios"
    static let RMBT_DEVELOPER_URL = "https://test.matuok.lt/"
